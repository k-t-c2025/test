 ...
 */
function createPostObject(name, message) {
    return {
        id: generateId(),
        name: name,
        message: message,
 ...
 */
function addPost(name, message, parentId = null) {
    const post = createPostObject(name, message);
...
function createPostElement(post) {
    ...
    postDiv.appendChild(createPostContent(post.message));
